...
#include<string.h>
void main(){
    FILE *fp_ou,*fp_op,*fp_len,*fp_sy,*fp_sy,*fp_opc,*fp_samp,*fp_read;
    int i,j,len,reclen=0,loc;
    char symnam[5],code[5],start[10],label[20],opcode[10],operand[10],symloc[10],mnemonic[10],a[20],b[20],count[20],s;
